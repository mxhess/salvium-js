/**
 * 日本語 word list for Salvium mnemonic seeds
 * Source: salvium/src/mnemonics/japanese.h
 * Words: 1626
 * Unique prefix length: 3
 */

export const name = '日本語';
export const englishName = 'japanese';
